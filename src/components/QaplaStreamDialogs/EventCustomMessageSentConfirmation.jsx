...
import { ReactComponent as TickMessage } from './../../assets/TickMessage.svg';
...
const EventCustomMessageSentConfirmation = ({ open, onClose }) => {
            ...
            <DialogContent style={{ padding: '0px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <div style={{ display: 'flex', width: '90px', height: '90px' }}>
                        ...
                        <TickMessage style={{ width: '90px', height: '90px' }} />
                    </div>
                    <div style={{ height: '34px' }} />
                    <p className={classes.miniDialogTitle}>
                        {t('QaplaStreamDialogs.EventCustomMessageSentConfirmation.title')} ✈️
                    </p>
                    ...
                    <Button
                        ...
                        {t('QaplaStreamDialogs.EventCustomMessageSentConfirmation.manageRewards')}
                    </Button>
                </div>
            </DialogContent>
        </Dialog>
...
export default EventCustomMessageSentConfirmation;
